...
const CampSite = ({
  ...
  return (
    <div
      className={` -yellow-300  h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl `}
    >
      <div className="flex  -blue-700 h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10 ">
        <div className="flex  -red-700  items-center justify-center">
...
const Camp = () => {
  return (
    <section className="-2 -green-500 2xl:max-container relative flex flex-col py-10 lg:py-20 xl:mb-20 ">
      ...
      <div className="flex  -r-green-50 items-center justify-end mt-10 px-6 lg:-mt-60 lg:mr-6">
